@echo off
cd /d C:\SwitchMap
C:\SwitchMap\venv\Scripts\python.exe manage.py normalize_mikrotik_visual_ports
...
timeout /t 5 >nul
C:\SwitchMap\venv\Scripts\python.exe smoke_tests\run_smoke.py current
if errorlevel 1 exit /b 1
echo PHASE41_7_APPLY_OK
