...
echo PHASE88_2_SCHEDULED_COVERAGE_UPDATE_START
...
if errorlevel 1 (
  echo PHASE88_2_FAIL django_check
  exit /b 1
)
...
if errorlevel 1 (
  echo PHASE88_2_FAIL py_compile
  exit /b 1
)
...
if errorlevel 1 (
  echo PHASE88_2_FAIL storage_verify_before
  exit /b 1
)
...
if errorlevel 1 (
  echo PHASE88_2_FAIL schtasks_create
  exit /b 1
)
