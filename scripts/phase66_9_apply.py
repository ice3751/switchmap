...
PHASE = "phase66_9_preview_typography_responsive_refinement"
FILES = [
    ...
    "docs/PHASE66_9_PREVIEW_TYPOGRAPHY_RESPONSIVE.md",
]
SMOKE_REL = "smoke_tests/switchmap_66_9_preview_typography_responsive_smoke_test.py"


def fail(message: str) -> None:
    print("PHASE66_9_COPY_FAIL=" + message)
    raise SystemExit(1)
...
def patch_manifest(root: Path, backup: Path) -> None:
    ...
    p = root / rel
    if not p.exists():
        print("PHASE66_9_MANIFEST_SKIPPED_MISSING")
        return
    backup_file(root, backup, rel)
    ...
    data["phase66_9"] = [SMOKE_REL]
    p.write_text(json.dumps(data, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
    print("PHASE66_9_MANIFEST_PATCHED")
